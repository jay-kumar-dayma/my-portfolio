...
function Contact() {
  ...
  return (
    <section className="min-h-screen bg-[#1a1a2e] px-8 md:px-16 py-16">
      ...
      {/* Section heading */}
      <h2 className="text-white text-4xl font-bold mb-2">Contact <span className="text-[#e94560]">Me</span></h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              <span className="text-[10px] text-gray-500 uppercase tracking-widest">Phone</span>
          ...
          <div className="flex gap-4">
            <a href={info.social.github} target="_blank" rel="noreferrer" className="text-sm text-gray-400 hover:text-[#e94560] transition duration-200">GitHub →</a>
            <a href={info.social.linkedin} target="_blank" rel="noreferrer" className="text-sm text-gray-400 hover:text-[#e94560] transition duration-200">LinkedIn →</a>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button type="submit" className="px-8 py-3 bg-[#e94560] text-white rounded font-medium hover:opacity-85 transition duration-200">
            Send Message
          </button>
        </form>
